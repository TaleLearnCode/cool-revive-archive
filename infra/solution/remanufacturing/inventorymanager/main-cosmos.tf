...
resource "azurerm_cosmosdb_account" "inventory_manager" {
  name                = lower("${module.cosmos_account.name.abbreviation}-CoolRevive-InvMgr${var.resource_name_suffix}-${var.azure_environment}-${module.azure_regions.region.region_short}")
