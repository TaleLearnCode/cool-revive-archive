...
resource "azurerm_application_insights" "remanufacturing" {
  name                = "${module.application_insights.name.abbreviation}-CoolRevive_Remanufacturing${var.resource_name_suffix}-${var.azure_environment}-${module.azure_regions.region.region_short}"
